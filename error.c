...
/*   Updated: 2021/02/05 14:53:05 by lebourre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	**gen_error_list(void)
{
	...
	if (!(error = malloc(sizeof(char *) * 22)))
		return (NULL);
	error[0] = "Error: malloc can't allocate the memory\n";
	error[1] = "Error: resolution not set or not setp properly. Resolution can only contain numbers and spaces\n";
	...
	error[7] = "Error: floor color not set or incorrect. RGB must contain numbers, and comma in between (spaces are allowed, but commas are mandatory).\n";
	error[8] = "Error: ceilling color not set or incorrect. RGB must contain numbers, and one comma in between (spaces are allowed, but commas are mandatory).\n";
